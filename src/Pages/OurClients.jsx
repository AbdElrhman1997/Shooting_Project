...
const OurClients = () => {
  return (
    <section>
      <GeneralFrame
        content={
          <div className="bg-white text-black rounded-[30px]  py-12">
            <div className="">
              <div className="bg-white">
                ...
                <p className="2xl:text-3xl xl:text-3xl lg:text-3xl md:text-3xl text-xl mt-8 font-bold 2xl:px-12 xl:px-12 lg:px-12 md:px-8 px-4 2xl:text-right xl:text-right lg:text-right md:text-right text-center">
                  عملائنا..ديواننا وعميلنا..هو نهج قصيدتنا
                </p>
                <div className="relative flex justify-center bg-[#000] ">
                  <div className="flex flex-wrap justify-center border-b-2 2xl:px-12 xl:px-12 lg:px-12 md:px-8 px-4 border-[#000] bg-white rounded-bl-[30px] rounded-br-[30px]">
              ...
              <div className="relative flex justify-center bg-[#000] ">
                <div className="bg-white rounded-[30px]">
                  ...
                  <p className="text-black text-center font-bold mt-4 2xl:text-2xl xl:text-2xl lg:text-2xl md:text-2xl text-xl">
                    هو الذي يخلدة الزمن في ذهن التاريــخ
                  </p>
