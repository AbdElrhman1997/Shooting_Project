        ...
        content={
          ...
          >
                ...
                <div className="bg-white flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col font-bold items-start w-full rounded-[30px] 2xl:mt-12 xl:mt-12 lg:mt-12 md:mt-12 mt-6">
                  <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 w-full 2xl:px-8 xl:px-8 lg:px-8">
                    ...
                    >
                      ...
                      وضع مطعمك في المنطقة أو الحي مستندا إلى فهم جيد لجمهــــور
                      الزبـــائن المستهدفين ونوع المأكولات التي تقدمها
                      <div className="mt-3">
                        تقييم المساحة المتاحة في الموقع المختار حسب حجم المطبخ
                ...
                <div className="bg-white flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col font-bold items-start w-full rounded-[30px]">
                  <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 w-full 2xl:px-8 xl:px-8 lg:px-8">
                    ...
                    >
                      ...
                      تجهيز مستلزمات المطاعم التي يجب توافرها بأعلى جودة ( أفران
                      الطهي المختلفة - مواقـد الطهي - أواني الطهي ومقـالي -
                      معدات التحضيـــر - معــدات التبريــد والتجميـد معدات
                      تخزيـــــن المـــواد الخـــام - أدوات القطع والتقديـم
                      أدوات الحمـــــــاية والسلامة - أواني تقديــــــم
                      الطعـــــــام أدوات التنظيف - أواني التخزيـن والتوزيع -
                      معدات الطهي الخاصة )
                    </div>
                  </div>
                ...
                <div className="bg-white flex 2xl:flex-row xl:flex-row lg:flex-row md:flex-row flex-col font-bold items-start w-full rounded-[30px]">
                  ...
                  <div className="2xl:w-1/2 xl:w-1/2 lg:w-1/2 w-full 2xl:px-8 xl:px-8 lg:px-8">
                    ...
                    >
                      ...
                      <div>١-التدريب وتطوير الموظفين</div>
            ...
            >
              ...
              >
                خدمات شوت انج المساندة للمطاعم
              </p>
