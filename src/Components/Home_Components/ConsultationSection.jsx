    ...
    <section className="mt-6" dir="rtl">
      <div className="relative">
        ...
        <div className="xl:px-20 lg:px-20 md:px-20 px-8 relative z-10 2xl:mt-16 xl:mt-16 lg:mt-16 md:mt-16 mt-0">
          <div className="text-black font-bold xl:text-3xl lg:text-2xl md:text-xl text-[13.6px]">
          ...
          <Link
            ...
            className="rounded-full block bg-[#ec3237] w-fit 2xl:px-12 xl:px-12 lg:px-12 md:px-8 px-4 2xl:py-12 xl:py-4 lg:py-4 md:py-4 py-2   mt-6 font-bold xl:text-3xl lg:text-xl md:text-xl text-[14px]"
          >
